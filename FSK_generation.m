...
x=[ 0 1 0 1 1 0 0];                                    	% Binary Information Input
bp=0.001;                                            	% bit period (sampling period)
...
% Representation of binary information as digital signal which achieved after demodulation 
bit=[];
for n=1:length(mn);
    if mn(n)==1;
       se=ones(1,100);
